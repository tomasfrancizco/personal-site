              ...
              <div className="uk-card uk-card-default">
                ...
                <div className="uk-card-body">
                  ...
                  <p>
                    ...
                    usuarios pueden compartir sus recetas, guardar sus favoritas
                    y buscar otras de acuerdo a los ingredientes con los que
                    cuentan en el momento.
                  </p>
              ...
              <div className="uk-card uk-card-default">
                ...
                <div className="uk-card-body">
                  ...
                  <p>
                    ...
                    <br />
                    Cuenta la historia de una lucha entre personajes típicos de
                    la colonia, teniendo como Jefa final a la niña conocida por
                    ser la voz del camión que recoge electrodomésticos.
                    <br />
            ...
            <div>
              <div className="uk-card uk-card-default">
                ...
                <div className="uk-card-body">
                  ...
                  <p>
                    Una plataforma en la que los usuarios, luego de registrarse
                    y acceder, pueden realizar denuncias y/u observaciones
                    acerca de situaciones o problemas con los que se cruzan en
                    la ciudad.
                    <br />
